...
define('scenario/steps_list',["jquery", "underscore", "Element", "Action", "scenario/keycode", "EventEmitter"],
  function($, _, Element, Action, keyCode, EventEmitter) {
  'use strict';
  ...
  stepsList.reset = function(actions) {
    ...
    let addedEvents = steps.reduce(function(sum, s) { return s.events.length + sum; }, 0);
  ...
  const MouseStep = Object.create(Step, {
    ...
    display: {
      value: function() {
        var a = "";
        if (_.find(this.events, function(e) { return e.type === "click"; })) {
          a = "Click";
        } else if (_.find(this.events, function(e) { return e.type === "mousedown"; })) {
          if (_.find(this.events, function(e) { return e.type === "mouseup"; } )) {
            a = "Mouse down and up";
          } else {
            a = "Mouse down";
          }
    ...
    display: {
      value: function() {
        ...
        return Displayable.displayAction("Type") +
                " [" +
                keysStr.map(function(k) { return "<span>"+k+"</span>"; }).join(', ') +
                "]" +
                " on " +
                Displayable.displayTarget(this.element().toString());
      }
  ...
  const TabStep = Object.create(Step, {
    ...
    display: {
      value: function() {
        var ku;
        if (ku =_.find(this.events, function(e) { return e.type === "keyup"; })) {
...
define('scenario/scenario_controller',["jquery", "scenario/webview", "scenario/steps_list", "Element", "Action", "windows", "Scenario", "ScenarioResult", "bootstrap-notify", "q", "EventEmitter"],
  function($, webview, stepsList, Element, Action, windows, Scenario, ScenarioResult, _bootstrap_notify, Q, EventEmitter) {
  "use strict";
...
define("bootstro", ["jquery","bootstrap"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.bootstro;
    };
}(this)));
...
requirejs(["jquery",
            ...
            "q",
            "DataSet"],
  function($, _b, scenarioController, ScenarioResult, Element, windows, utils, bootstro, Q, DataSet) {
    'use strict';
    ...
    const dataManageComponent = (function() {
      ...
      function createRow(name, value, regex) {
        let row = $("<tr />", { "class": "data-manage-added-data" }).append(
          ...
          $("<td />", { "class": "data-manage-data-value" }).append($("<input />", { "value": value, "class": "form-control" })),
