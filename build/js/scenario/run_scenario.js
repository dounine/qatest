...
requirejs(["jquery", "bootstrap", "scenario/scenario_controller", "windows"],
  function($, _b, scenarioController, windows) {
  'use strict';
  $(function() {
    ...
    chrome.runtime.getBackgroundPage(function(bg) {
      ...
      bg.mixpanel.track("TestScenario start");
    });
